...
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["适用于 11.7x 的 SANtricity System Manager 联机帮助"]
* https://docs.netapp.com/us-en/e-series-santricity-116/system-manager/index.html["适用于 11.6x 的 SANtricity System Manager 联机帮助"]
