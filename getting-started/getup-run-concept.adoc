...
要安装 E-Series 硬件，请访问您的存储阵列和托架类型（如果适用）的安装和设置说明：

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["EF50 或 EF80 存储系统"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager 12.0x 联机帮助"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["适用于11.9x的SANtricity System Manager联机帮助"^]
