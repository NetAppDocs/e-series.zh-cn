...
Unified Manager 是基于 Web 的软件，用于管理整个域。从中央视图中，您可以查看所有较新 E-Series 和 EF-Series 阵列的状态，例如 EF50、EF80、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C 和 EF600C。您还可以在选定的存储阵列上执行批处理操作。
...
命令行界面 (CLI) 是一种软件应用程序，它提供了一种配置和监控存储阵列的方法。使用 CLI，可以从操作系统提示符运行命令，例如  `DOS C:` 提示符、Linux 操作系统路径或 Solaris 操作系统路径。
