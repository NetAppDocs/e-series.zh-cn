...
NOTE: 可能支持其他接口和操作系统。有关详细信息，请联系技术支持。
 ...
 a| 
本网站不包含早于软件版本 11.50 或固件版本 8.50 的版本信息。有关早期版本，请转到 https://docs.netapp.com/us-en/e-series-santricity/early-versions.html#software-documentation-for-earlier-releases["早期版本的 E-Series 和 SANtricity 文档"^]页面。
