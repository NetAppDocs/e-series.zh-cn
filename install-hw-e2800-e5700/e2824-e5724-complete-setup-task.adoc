...
---
= 完整的存储系统设置和配置—E5724、EF570、EF280、E2812、E2824、DE212C和DE224C
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
 ...
 a| 
image:../media/2U_DirectTopology.png["直连拓扑布线"]
 a| 
...
|===
 ...
 a| 
image:../media/2U_FabricTopology.png["光纤拓扑布线"]
 a| 
. 将每个主机适配器直接连接到交换机。
...
|===
 ...
 a| 
image:../media/cable_ethernet_inst-hw-e2800-e5700.png["以太网布线"]
 a| 
以太网缆线（如果订购）
