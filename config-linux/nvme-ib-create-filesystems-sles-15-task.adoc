...
---
= 在 E 系列 Linux RHEL 8、RHEL 9、RHEL 10、SLES 15 和 SLES 16（基于 InfiniBand 的 NVMe）中创建文件系统
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
对于 RHEL 8、RHEL 9、RHEL 10、SLES 15 和 SLES 16，您需要在本地 nvme 设备上创建文件系统并挂载该文件系统。
