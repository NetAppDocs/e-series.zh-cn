...
---
= 使用SANtricity系统管理器分配卷—Linux (基于RoCE的NVMe)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.步骤
. 在 SANtricity System Manager 界面的左侧面板中，选择菜单：Storage[Hosts]。
...
.下一步是什么？
分配卷后，link:nvme-roce-display-volumes-visible-host-task.html["向主机显示可见卷"]。
