...
.EF280 和 EF50 控制器型号
--
有关安装新的 EF80 和 EF50 控制器的信息，请参见 link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 和 EF80 - 步骤 7：安装控制器"^]。
