...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_led_callout_maint-e2800.gif[风扇箱LED]
...
. 按下橙色卡舌以释放风扇箱手柄。
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e2800.gif[风扇罐释放卡舌]
...
. 使用风扇箱把手将风扇箱拉出磁盘架。
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e2800.gif[风扇罐拉手]
