...
+
... 选择 * 硬件 * 。
... 如果图形显示驱动器，请选择 *Show back of shelf* 以显示控制器
... 选择要置于脱机状态的控制器。
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[卸下该纸]
...
+
image::../media/28_dwg_e2800_insert_battery_maint-e2800.gif[重新安装电池]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[在控制器上重新安装HIC]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[重新安装该安装的]
