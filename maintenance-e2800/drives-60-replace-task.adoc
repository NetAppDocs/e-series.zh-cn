...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e2800.gif[E2800驱动器抽屉上的警示LED]
...
+
image::../media/2860_dwg_amber_on_drive_maint-e2800.gif[E2800驱动器抽屉上的警示LED]
...
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e2800.gif[驱动器盘位上的警示图标和LED]
...
+
image::../media/trafford_drive_rel_button_maint-e2800.gif[驱动器抽屉上的橙色释放闩锁]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e2800.gif[使用凸轮把手从磁盘架上提起驱动器]
