...
NOTE: 有关如何在 VMware 配置上设置阵列端网络的其他信息，请参见以下技术报告： https://www.netapp.com/pdf.html?item=/media/17017-tr4789.pdf["《 VMware E 系列 SANtricity iSCSI 与 ESXi 6.x 和 7.x 集成配置指南》"^]。
