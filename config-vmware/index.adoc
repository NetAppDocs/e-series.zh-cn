...
** link:nvme-roce-perform-specific-task.html["基于 RoCE 的 NVMe"]
...
* https://www.netapp.com/pdf.html?item=/media/17017-tr4789.pdf["《 VMware E 系列 SANtricity iSCSI 与 ESXi 6.X 集成配置指南》"^] -- 提供有关 iSCSI 与 VMware 集成的技术详细信息。
