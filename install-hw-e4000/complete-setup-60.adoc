...
image:../media/drw_labeled_e4060_direct_topology_ieops-2158.svg["E4060直接拓扑、宽度= 1000个峰值"]
...
image:../media/drw_e4060_fabric_topology_ieops-2159.svg["E4060网络结构拓扑、宽度=1000个峰值"]
