...
NOTE: 如果没有看到下面列出的控制器盘架（存储系统），请参阅 link:../getting-started/getup-run-concept.html["E系列快速入门"^] 并单击特定存储系统的链接以访问布线信息。
...
如果要为以下任意配置布线，请参阅 https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["将 IOM 驱动器架添加到现有 E27XX ， E56XX 或 EF560 控制器架。"^]
...
|===
有关支持镜像功能的布线的信息，请参见 https://www.netapp.com/pdf.html?item=/media/17133-tr4656.pdf["《同步和异步镜像功能说明和部署指南》"^]。
