...
+
image::../media/e5700_mac_address_and_fru_part_number.png[E5700控制器上的MAC地址和FRU部件号"]
...
+
.. 选择 * 硬件 * 。
.. 找到标有控制器图标的控制器架image:../media/sam1130_ss_hardware_controller_icon_maint-e5700.gif["控制器图标"]。
.. 单击控制器图标。
.. 选择控制器，然后单击 * 下一步 * 。
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e5700.gif[从控制器上卸下控制器的控制器]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e5700.gif[从控制器卡中卸下HIC"]
...
+
image::../media/28_dwg_e2800_insert_battery_maint-e5700.gif[重新安装电池]
...
+
image:../media/28_dwg_e2800_battery_flange_ok_maint-e5700.gif["正确的金属法兰"]

** * 不正确 * —电池的金属法兰未插入控制器上的插槽：
+
image:../media/28_dwg_e2800_battery_flange_not_ok_maint-e5700.gif["金属法兰不正确"]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e5700.gif['将HIC重新安装到控制器卡上']
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e5700.gif[重新安装打印器"]
