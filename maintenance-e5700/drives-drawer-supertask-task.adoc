...
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e5700.gif[橙色棕褐色、用于松开风扇罐手柄]
...
+
image::../media/trafford_cable_rail_1_maint-e5700.gif[驱动器抽屉的电缆链和连接器]
...
+
image::../media/trafford_cable_rail_3_maint-e5700.gif[用于驱动器抽屉的垂直导轨和电缆链的橙色环]
...
+
image::../media/trafford_cable_rail_2_maint-e5700.gif[用于水平导轨的橙色环和用于驱动器抽屉的电缆链]
...
+
image::../media/dwg_trafford_drawer_with_hdds_callouts_maint-e5700.gif[驱动器插槽编号]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[使用凸轮把手卸下驱动器]
...
+
image::../media/92_pht_de6600_drive_drawer_release_lever_maint-e5700.gif[释放拉杆以卸下抽盒]
...
+
image::../media/92_pht_de6600_lock_out_tumbler_detail_maint-e5700.gif[锁定翻转器和抽屉导轨]
...
+
image::../media/2860_dwg_both_guide_rails_maint-e5700.gif[水平和垂直导轨]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[使用手柄将驱动器降到抽盒上]
