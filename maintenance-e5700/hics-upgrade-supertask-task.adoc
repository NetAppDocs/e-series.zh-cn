...
+
image::../media/28_dwg_e2800_internal_cache_active_led_maint-e5700.gif[缓存活动LED]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e5700.gif[从控制器卡上卸下HIC]
...
+
image::../media/e5700_hic_3_callouts_maint-e5700.gif[E5700控制器LED指示灯"]
