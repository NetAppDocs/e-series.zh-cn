...
+
image::../media/sam1130_ss_e2800_unified_spf_maint-e5700.gif[sam1130 ss e2800 统一 SPF 维护 e5700]
...
+
image::../media/sam1130_ss_e2800_storage_array_profile_sn_smid_copy_maint-e5700.gif[sam1130 ss e2800 存储阵列配置文件 SN SMID 副本维护 e5700]
...
.. 找到起始配置的功能包子型号 ID 。
+
image::../media/storage_array_profile2_maint-e5700.gif[存储阵列 profile2 维护 e5700]
...
+
image::../media/sam1130_ss_e2800_change_feature_pack_feature_enable_identifier_copy_maint-e5700.gif[sam1130 ss e2800 change feature pack 功能启用了标识符副本 maint e5700]
...
. 等待缓存中的所有数据写入驱动器。
+
需要将缓存数据写入驱动器时，每个控制器背面的绿色缓存活动 LED * （ 1 ） * 亮起。您必须等待此 LED 关闭。image:../media/e5700_ib_hic_w_cache_led_callouts_maint-e5700.gif[""]
