...
[role="lead"]
您可以在 E-Series 3040 40U 机柜中安装以下控制器驱动器托盘和扩展驱动器托盘。

如果您的控制器驱动器托盘或扩展驱动器托盘未在下面列出，请参阅 https://hwu.netapp.com["NetApp Hardware Universe"^]以验证是否支持您的控制器驱动器托盘或扩展驱动器托盘。
