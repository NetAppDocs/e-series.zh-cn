...
summary: 机架安装硬件用于将硬件安装在机架或机柜中。安装说明应包含在机架安装硬件包装盒中。但是，如果您需要访问安装说明，请使用以下适用链接。 
---
= 机架安装硬件 - E-Series
:allow-uri-read: 
:icons: font
...
[role="lead"]
机架安装硬件用于将存储系统安装在机架或机柜中。安装说明应包含在机架安装硬件包装盒中。但是，如果您需要访问安装说明，请使用以下适用的链接。

对于较新的存储系统，您可以通过查看 NetApp Hardware Universe 来验证受支持的机架安装硬件 https://hwu.netapp.com["NetApp Hardware Universe"^]。
...
访问 https://docs.netapp.com/us-en/ontap-systems/platform-supplemental/superrail-install.html["将 SuperRail 安装到四柱式机架中"^]。
